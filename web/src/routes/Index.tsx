        ...
        <div className="w-full bg-gray-100 rounded-lg mx-auto my-20 pt-8 border-2 border-gray-200">
            ...
            <div className="card">
                ...
                <div className="flex justify-center space-x-4 mt-8">
                    <Link to="/register"
                          className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-2 px-4 transition-colors duration-300">Register</Link>
                    <Link to="/login"
                          className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-2 px-4 transition-colors duration-300">Login</Link>
                    {isLoggedIn
                      ? (
                            <Link to="/events"
                                  className="bg-green-500 hover:bg-green-600 text-white rounded-lg py-2 px-4 transition-colors duration-300">
                                Events
                            </Link>
                        )
                      : (
