...
export const { useLoginMutation, useFetchEventsQuery, useRegisterUserMutation, useProfileQuery, useEventQuery, useCreateEventMutation, useDeleteAccountMutation } = apiSlice;